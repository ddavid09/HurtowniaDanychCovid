...
CREATE TABLE [dbo].[PACJENT_DIM](
	...
	[WIEK] [int] NOT NULL,
	[PLEC] [int] NOT NULL,
	[DATA_ZAKAZENIA] [date] NOT NULL,
	[STAN] [nvarchar](50) NOT NULL,
	[STAN_UPD_DATE] [date] NULL,
	)
GO
...
CREATE TABLE [dbo].[STAN_PACJENTA_DET](
	[FAKT_ID] [int] IDENTITY(1,1) NOT NULL,
...
INSERT INTO [dbo].[TYP_ZDARZENIA_DIM] ([NAZWA_ZDARZENIA]) VALUES ('zakazenie');
INSERT INTO [dbo].[TYP_ZDARZENIA_DIM] ([NAZWA_ZDARZENIA]) VALUES ('wyzdrowienie');
INSERT INTO [dbo].[TYP_ZDARZENIA_DIM] ([NAZWA_ZDARZENIA]) VALUES ('smierc');
GO
...
BEGIN
	INSERT INTO [dbo].[CZAS_DIM]([DATA], [DZIEN], [MIESIAC], [ROK])
	VALUES(
			@startdate,
...
ALTER TABLE [dbo].[STAN_PACJENTA_DET] 
...
ALTER TABLE [dbo].[STAN_PACJENTA_DET] ADD 
	CONSTRAINT [FK_STAN_PACJENTA_CZAS] FOREIGN KEY ([CZAS_ID]) REFERENCES [dbo].[CZAS_DIM] ([CZAS_ID]),
	CONSTRAINT [FK_STAN_PACJENTA_GEOGRAFIA] FOREIGN KEY ([GEOGRAFIA_ID]) REFERENCES [dbo].[GEOGRAFIA_DIM] ([GEOGRAFIA_ID]),
	CONSTRAINT [FK_STAN_PACJENTA_TYP_ZDARZENIA] FOREIGN KEY ([TYP_ZDARZENIA_ID]) REFERENCES [dbo].[TYP_ZDARZENIA_DIM] ([TYP_ZDARZENIA_ID]),
	CONSTRAINT [FK_STAN_PACJENTA_PACJENT] FOREIGN KEY ([PACJENT_ID]) REFERENCES [dbo].[PACJENT_DIM] ([PACJENT_ID]);
GO
